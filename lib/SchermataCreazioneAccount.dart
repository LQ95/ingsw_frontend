...
class SchermataCreazioneAccount extends StatefulWidget {
  ...
  @override
  SchermataCreazioneAccountState createState() =>
      SchermataCreazioneAccountState();
}
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                DropdownButton<String>(
                                  ...
                                  items: listaRuoli.map<DropdownMenuItem<String>>(
                                        (String value) {
                                  ...
                                  onPressed: () async {
                                    if (controller1.text.isNotEmpty &&
                                      ...
                                      if (creazioneAvvenutaConSuccesso == "SUCCESSO") {
                                        showAllertSuccesso();
                                      } else if (creazioneAvvenutaConSuccesso ==
                                          "FALLIMENTO") {
                                        showAllertErrore(
  ...
  void showAllertSuccesso() {
    QuickAlert.show(
      ...
      onConfirmBtnTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => MenuPrincipale()),
        );
      },
    );
  }
